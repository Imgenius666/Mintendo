...
public class SaveView {
    ...
    public void saveBoard() {
        saveBoardLabel.setText("");
        saveFileErrorLabel.setText("");

        String file = saveFileNameTextField.getText().trim();
        String path = "boards/" + file;
        ...
        if (!file.endsWith(".ser")) {
            ...
            tetrisView.model.saveModel(f);
            saveBoardLabel.setText(SaveView.saveFileSuccess);
        }
    }
}