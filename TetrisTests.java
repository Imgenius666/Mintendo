...
//        TetrisPiece p = new TetrisPiece(TetrisPiece.PYRAMID_STR);
//        p = TetrisPiece.makeFastRotations(p);
//        String[] t = {"0 0 0 1 0 2 1 1", "1 0 0 1 1 1 2 1", "0 1 1 0 1 1 1 2", "0 0 1 0 2 0 1 1"};
//        int c = 0;
//        while (c < 4) {
//            TetrisPiece n = new TetrisPiece(t[c]);
//            p = p.fastRotation();
//            assertTrue(n.equals(p), "Error when testing piece equality");
//            c++;
    ...
    void testEquals() {
        ...
        TetrisPiece pieceA = new TetrisPiece("1 0  1 1  0 1  1 2");
